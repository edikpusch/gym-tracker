...
export default function PlansPage() {
  ...
  if (!plans.length) return <div style={{ minHeight: "var(--app-viewport-height)", background: "var(--c-bg)", display: "grid", placeItems: "center", color: "var(--c-text-3)" }}>Pläne werden geladen …</div>;

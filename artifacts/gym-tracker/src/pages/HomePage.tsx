...
export default function Home() {
  ...
  const menuItems = [
    ...
    { key: "history", section: "Analyse", label: "Verlauf", icon: "🕘", href: "/history" },
    { key: "stats", section: "Analyse", label: "Statistiken", icon: "◔", href: "/statistics" },
    { key: "progress", section: "Analyse", label: "Fortschritte", icon: "📈", href: "/progress" },
    { key: "weight", section: "Analyse", label: "Gewicht", icon: "⚖️", href: "/weight" },
    { key: "settings", section: "System", label: "Einstellungen", icon: "⚙️", href: "/settings" },
    { key: "support", section: "System", label: "Hilfe & Support", icon: "❔", href: "/support" },
  ];
